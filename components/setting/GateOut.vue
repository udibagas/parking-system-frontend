<template>
  <div>
    <div class="text-right">
      <el-button type="primary" icon="el-icon-plus" @click="openForm()" size="small">TAMBAH GATE KELUAR</el-button>
    </div>
    ...
    <el-table :data="tableData.data" stripe height="calc(100vh - 300px)">
      ...
      <el-table-column prop="shortcut_key" label="Shortcut" align="center" header-align="center"
        min-width="100"></el-table-column>

      <el-table-column min-width="100" label="Pos" prop="pos.nama"></el-table-column>

      <el-table-column min-width="150" label="Jenis Kendaraan" prop="jenis_kendaraan">
        <template slot-scope="scope">
          {{
      ...
      <el-table-column min-width="120" label="Perintah Buka" prop="open_command"></el-table-column>

      <el-table-column min-width="120" label="Perintah Tutup" prop="close_command"></el-table-column>
        ...
        <template slot-scope="scope">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item icon="el-icon-minus" @click.native.prevent="testGate(scope.row)">Test
                Gate</el-dropdown-item>
              <el-dropdown-item icon="el-icon-chat-dot-square" @click.native.prevent="testRunningText(scope.row)">Test
                Running Text</el-dropdown-item>
              <el-dropdown-item icon="el-icon-edit" @click.native.prevent="openForm(scope.row)">Edit</el-dropdown-item>
    ...
    <el-dialog v-loading="loading" title="GATE KELUAR" :close-on-click-modal="false" :visible.sync="showForm">
      <el-form label-position="left" label-width="150px">
        ...
        <el-form-item label="Jenis Kendaraan" :class="formErrors.jenis_kendaraan ? 'is-error' : ''">
          <el-select v-model="formModel.jenis_kendaraan" placeholder="Jenis Kendaraan" style="width: 100%" multiple>
            <el-option v-for="k in jenisKendaraanList" :value="k.nama" :label="k.nama" :key="k.id"></el-option>
          </el-select>
        ...
        <el-form-item label="Controller" :class="formErrors.device ? 'is-error' : ''">
          <div class="flex">
            <el-input class="mr-2" placeholder="Device" v-model="formModel.device"></el-input>
            <el-input type="number" placeholder="Baudrate" v-model="formModel.baudrate"></el-input>
          </div>
        ...
        <el-form-item label="UHF Reader">
          <div class="flex">
            <el-input class="mr-2" placeholder="IP Address" v-model="formModel.uhf_reader_host"></el-input>
            <el-input type="number" placeholder="Port" v-model="formModel.uhf_reader_port"></el-input>
          </div>
        </el-form-item>

        <el-form-item label="Running Text">
          <div class="flex">
            <el-input class="mr-2" placeholder="Device" v-model="formModel.running_text_device"></el-input>
            <el-input type="number" placeholder="Baudrate" v-model="formModel.running_text_baudrate"></el-input>
          </div>
        </el-form-item>

        <el-form-item label="Perintah Buka" :class="formErrors.open_command ? 'is-error' : ''">
          <el-input placeholder="Perintah Buka" v-model="formModel.open_command"></el-input>
        ...
        <el-form-item label="Perintah Tutup" :class="formErrors.close_command ? 'is-error' : ''">
          <el-input placeholder="Perintah Tutup" v-model="formModel.close_command"></el-input>
        ...
        <el-form-item label="Pos" :class="formErrors.pos_id ? 'is-error' : ''">
          <el-select v-model="formModel.pos_id" placeholder="Pos" style="width: 100%">
            <el-option v-for="pos in posList" :value="pos.id" :label="pos.nama" :key="pos.id"></el-option>
          </el-select>
